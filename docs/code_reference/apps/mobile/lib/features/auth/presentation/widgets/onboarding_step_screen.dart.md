# onboarding_step_screen.dart

* **File Path:** `apps/mobile/lib/features/auth/presentation/widgets/onboarding_step_screen.dart`
* **Type:** `DART`
                      ...
                      child: Padding(
                        padding: EdgeInsets.only(
                          ...
                          top:
                              ...
                              AdaptiveLayout.padding(context, 10),
                        ),
                        child: Column(
                            ...
                            Column(
                              ...
                              children: [
                                if (headerIcon != null) ...[
                                  headerIcon!,
                                  SizedBox(
                                    height: AdaptiveLayout.h(context, 20),
                                  ),
                                ] else ...[
                                  SizedBox(
                                    height: AdaptiveLayout.h(context, 10),
                                  ),
                                ],
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(
                                    height: AdaptiveLayout.h(context, 12),
                                  ),
                                  AuthSecondaryButton(
